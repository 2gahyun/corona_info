    ...
    <div class="container">
        ...
        <div class="right_area">
            ...
            <div class="content_area">
                <div>
                    <p>누적확진</p>
                    <p id="accDecodeCnt">12,000,000</p>
                </div>
                <div>
                    <p>신규확진</p>
                    <p id="newDecodeCnt">567</p>
                </div>
                <div>
                    <p>격리 중</p>
                    <p id="isolateCnt">678</p>
                </div>
                <div>
                    <p>격리 해제</p>
            ...
            <div class="content_area">
                ...
                <div class="regional_age_chart_area">
                    <canvas id="accAgeChart1" style="width: 100%; height: 100%;"></canvas>
                </div>
                <div class="regional_age_chart_area">
                    <canvas id="accAgeChart2" style="width: 100%; height: 100%;"></canvas>
                </div>
            </div>
        </div>
    </div>
